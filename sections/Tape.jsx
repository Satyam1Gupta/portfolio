    ...
    <div className="py-16 lg:py-24 overflow-x-clip">
      <div className=' bg-gradient-to-r from-emerald-300 to-sky-400 -rotate-3 -mx-0.5'>
        <div className="flex [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
          <div className="flex flex-none gap-4 animate-move-left [animation-duration:25s]">
            {[...new Array(2)].fill(0).map((_, idx)=>(//it is just repeating the follwing operations two times continuously
              <div key={idx}>
                {words.map((word)=>(
