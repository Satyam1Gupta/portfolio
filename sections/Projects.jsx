		...
		<div className="flex justify-center">
			<div className="container pb-16 lg:py-24">
				<SectionHeader
					...
					description="See how I transformed concepts into engaging digitals experiences."
				/>
				<div className="flex flex-col mt-10 md:mt-20 gap-20">
					{portfolioProjects.map((project, index) => (
						<div className="sticky" style={{top:`calc(64px + ${index * 40}px)`}}>
							<Card
								key={index}
								classname="px-8 pt-8 md:pt-12 md:px-10 lg:px-20 lg:pt-16 pb-0 "
							>
